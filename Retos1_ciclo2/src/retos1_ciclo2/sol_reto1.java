...
// public int[] res = new int[] {0, 0, 0} ;
    ...
    private int[] participantes = new int[] {1764, 1933, 1970, 1734, 2117, 2140, 1657, 1962, 1963 } ;
...
//                "2. Reto Notas\n"+"3. Reto Carrera \n");    // salida por pantalla
        ...
        int seleccion = Integer.parseInt(JOptionPane.showInputDialog("Que reto desea solucinar : \n"
                +"1. Reto Tienda\n"+
                "2. Reto Notas\n"+
                "3. Reto Carrera \n"));
...
//        objeto = new  Retos1_ciclo2()  ;   // instancio
    ...
    public void respuesta(String A, String B, String C, int[] arreglo){
        ...
        reto = new sol_reto1();    // instanciar objeto
        float calif=0.0f;
        JOptionPane.showMessageDialog(null, "para el arreglo : " + Arrays.toString(reto.participantes)+ "\n"  +
                "su respuesta fue  : " + Arrays.toString(arreglo) + "\n" + 
                "lo correcto es  : " + Arrays.toString(resEsperada));

        System.out.println( "para el arreglo : " + Arrays.toString(reto.participantes) ) ;
        System.out.println( "su arreglo fue : " + Arrays.toString(arreglo) ) ;
        
        
        
        for(int i = 0 ; i < 3; i++  ){  
            JOptionPane.showMessageDialog(null, "\nPara El "+ texto[i] +
                    "se esperaba : " + resEsperada[i] +  
                    "  /  Su respuesta fue : " + arreglo[i] + "\n" );
    ...
    public void tipoReto(int seleccion){
        ...
        Reto1Carrera carrera  ;    //creo objeto carrera de la clase Retos1_ciclo
        carrera = new  Reto1Carrera()  ;   // instancio

        Reto1Tienda tienda  ;    //creo objeto carrera de la clase Retos1_ciclo
        tienda = new  Reto1Tienda()  ;   // instancio   
        
        Reto1Notas _notas  ;    //creo objeto carrera de la clase Retos1_ciclo
        _notas = new  Reto1Notas()  ;   // instancio
        ...
        switch(seleccion){
            case 1:   // reto tienda
            res = tienda.reporte(participantes);
            ...
            case 3:// reto carrera
            res = carrera.reporte(participantes);
